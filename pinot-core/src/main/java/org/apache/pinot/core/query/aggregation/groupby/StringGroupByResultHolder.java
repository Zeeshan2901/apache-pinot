 ...
 */
public class StringGroupByResultHolder implements GroupByResultHolder {
     ...
     */
    public StringGroupByResultHolder(int initialCapacity, int maxCapacity, String defaultValue) {
        _maxCapacity = maxCapacity;
        _defaultValue = defaultValue;

        _resultHolderCapacity = initialCapacity;
        _resultArray = new String[initialCapacity];
    ...
    public void ensureCapacity(int capacity) {
        ...
        if (capacity > _resultHolderCapacity) {
            ...
            String[] current = _resultArray;
            _resultArray = new String[_resultHolderCapacity];
